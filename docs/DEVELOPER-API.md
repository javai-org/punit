...
| `org.javai.punit.spec.*`                                                              | Internal spec model / registry / expiration / criteria                                                                                        | **no** — internal                                             |
| `org.javai.punit.model.*`                                                             | Internal data carriers                                                                                                                        | **no** — internal                                             |
| `org.javai.punit.controls.*`                                                          | Internal budget / pacing implementations                                                                                                      | **no** — internal                                             |
| `org.javai.punit.power`                                                               | Power-analysis helpers                                                                                                                        | **no** — internal (use SC features through criteria)          |
