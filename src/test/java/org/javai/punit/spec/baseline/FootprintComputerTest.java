...
class FootprintComputerTest {
    ...
    class CovariateDeclarationTests {
        ...
        @Test
        @DisplayName("declaration with different standard covariates should produce different hashes")
        void declarationWithDifferentStandardCovariatesShouldProduceDifferentHashes() {
            var declaration1 = new CovariateDeclaration(
